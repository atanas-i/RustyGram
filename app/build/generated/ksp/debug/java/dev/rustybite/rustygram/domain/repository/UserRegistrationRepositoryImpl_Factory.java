...
public final class UserRegistrationRepositoryImpl_Factory implements Factory<UserRegistrationRepositoryImpl> {
  ...
  public UserRegistrationRepositoryImpl_Factory(Provider<RustyGramService> serviceProvider,
  ...
  public static UserRegistrationRepositoryImpl_Factory create(
      Provider<RustyGramService> serviceProvider, Provider<Retrofit> retrofitProvider,
      Provider<ResourceProvider> resourcesProvider) {
    return new UserRegistrationRepositoryImpl_Factory(serviceProvider, retrofitProvider, resourcesProvider);
  }

  public static UserRegistrationRepositoryImpl newInstance(RustyGramService service,
      Retrofit retrofit, ResourceProvider resources) {
    return new UserRegistrationRepositoryImpl(service, retrofit, resources);
  }
}
